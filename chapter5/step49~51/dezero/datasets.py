...
class Dataset:
    """Unify the interface for accessing datasets by using this class
    spiral、MNISTなど実際のデータセットは常にこのクラスを継承する必要があります。
    ユーザーは、Spiralクラス や MNISTクラスなど実際のデータセットクラスにおいて `prepare()` メソッドに前処理, データ拡張処理をを記載します。
    """
    ...
    def __len__(self):
        """
        python の特殊メソッドであり `len()`関数を使ったときに呼ばれる
        """
        return len(self.data)

    def prepare(self):
        """
        Dataset Classの継承先でprepareを記載する
        """
        pass
